...
const TeacherStatsPage = () => {
  ...
  return (
    <div className={compactView ? 'sp-4' : 'p-6'}>
      <div className="max-w-7xl mx-auto">
        <div
          className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'} rounded-2xl shadow-sm ${
            compactView ? 'p-4' : 'p-6'
          } ${compactView ? 'mb-4' : 'mb-6'} flex items-center justify-between`}
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className={`${compactView ? 'text-xl' : 'text-2xl'} font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
          ...
          <Card className={`border-none shadow-sm ${darkMode ? 'bg-gray-800' : ''}`}>
            <CardHeader className={compactView ? 'pb-2' : 'pb-3'}>
              <div className="flex items-center justify-between">
                <CardDescription className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                  Total Cursos
                </CardDescription>
            ...
            <CardContent>
              <div className={`${compactView ? 'text-2xl' : 'text-3xl'} font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
        ...
        <Card className={`border-none shadow-sm ${darkMode ? 'bg-gray-800' : ''}`}>
          ...
          <CardContent>
            <div
              className={`h-64 flex items-center justify-center ${darkMode ? 'bg-gray-900' : 'bg-gray-50'} rounded-lg border-2 border-dashed ${
