...
import { BookOpen, FileText, Bell, ArrowLeft, PlayCircle, FilePen as FilePdf, BookmarkIcon, CheckCircle2, Calendar } from 'lucide-react'
...
export default function StudentCourseDetailPage({ courseId }) {
