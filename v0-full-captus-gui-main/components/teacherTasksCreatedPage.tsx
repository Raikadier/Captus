...
import { ClipboardList, Calendar, Pencil, FolderOpen, Plus, X, Save } from 'lucide-react'
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                <Button 
                  ...
                  onClick={() => router.push(`/teacher/reviews?course=${encodeURIComponent(task.course)}`)}
                >
                ...
                <Button 
                  variant="outline"
                  onClick={() => router.push(`/teacher/tasks/${task.id}/edit`)}
                >
                  <Pencil size={16} />
                </Button>
              </div>
