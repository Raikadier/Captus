...
import { BookOpen, FileText, ClipboardList, Bell, Users, ArrowLeft, PlayCircle, FilePen as FilePdf, BookmarkIcon, CheckCircle2, Clock, AlertCircle, Calendar } from 'lucide-react'
...
export default function StudentCourseDetailPage({ courseId }: { courseId: string }) {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'Apunte': return <BookmarkIcon className="w-4 h-4 text-green-600" />
